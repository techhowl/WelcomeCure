  ...
  return <div className="w-full h-screen relative flex flex-col md:flex-row items-center justify-between pt-24 px-4 md:px-0">
      <div className="container h-auto mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center">
        <div className="w-full md:w-1/2 flex flex-col justify-center py-8 md:py-16 z-10">
          {/* Heading */}
          <h1 className="text-base lg:text-xl xl:text-2xl [@media(min-width:1100px)]:text-3xl [@media(min-width:1300px)]:text-4xl [@media(min-width:1600px)]:text-4xl leading-tight tracking-tight text-[#1A1A1A] font-normal mb-4 text-center md:text-left">
            Bad sleep quality makes<br />
            you more prone to
          </h1>
          
          {/* Depression text */}
          <div className="text-[40px] md:text-[56px] font-bold leading-none tracking-tight text-[#1D9BD7] mb-6 text-center md:text-left">
            Depression
          </div>
          
          {/* Description */}
          <p className="text-lg md:text-xl tracking-tight text-[#1A1A1A] mb-10 max-w-md text-center md:text-left">
