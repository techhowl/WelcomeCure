...
export const Footer = () => {
  ...
  return (
    <footer className="bg-[url('/assets/footerbg.webp')] bg-cover bg-center w-full py-16 md:py-20 px-6 sm:px-8 lg:px-16">
      <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row justify-between items-start gap-10">
        ...
        <div className="flex flex-col items-start md:items-end gap-4 w-full md:w-auto">
          ...
          <div className="flex mt-3">
            ...
            <a href="https://www.instagram.com/welcomecureonline/" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
              <div className="flex items-center justify-center">
                <img 
